<section class="sidebar">
            <img src="{{ asset('/img/spk.jpg') }}" alt="" class="logo-spk">
            <div class="time">
            <p id="date"></p>
            <time id="crnt-time"></time>
            <p id="office-state"></p>
            ...
            <div>
                    <h5>STRÁNKOVÉ DNI A HODINY</h5>
                <div>
                    <span>Utorok 9:00–14:00</span>
                    <span>Streda 8:00–12:00 13:00–17:00</span>
                </div>
            </div> 
            ...
            <div>
                ...
                <span>Banka : Slovenská sporiteľňa</span>
                <span>Číslo účtu -IBAN: 0900 0000 0051 6294 7048</span>
                <span>SWIFT: GIBASKBX</span>
                <span>IČO: 421756820060</span>
                <span>DIČ: 2022958212</span> 
            </div>      
</section>
<button onclick="topFunction()" id="top" ><i class="fa fa-caret-up  fa-2x"></i></button>
<button  id="toggle" class="fa fa-bars  fa-2x"></button>